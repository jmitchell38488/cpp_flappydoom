...
namespace olc
{
	...
	public:
        ...
        void DrawStringDecal(const olc::vf2d& pos, const std::string& sText, const olc::vf2d& scale = { 1.0f, 1.0f }, const Pixel col = olc::WHITE);
		void DrawRotatedStringDecal(const olc::vf2d& pos, const std::string& sText, const float fAngle, const olc::vf2d& center = {0.0f, 0.0f},  
                                    const olc::vf2d& scale = { 1.0f, 1.0f }, const Pixel col = olc::WHITE);
		void DrawStringPropDecal(const olc::vf2d& pos, const std::string& sText, const olc::vf2d& scale = { 1.0f, 1.0f }, const Pixel col = olc::WHITE);
...
namespace olc
{
	...
	void Font::DrawStringDecal(const olc::vf2d& pos, const std::string& sText, const olc::vf2d& scale, const Pixel col)
	{
	...
	void Font::DrawRotatedStringDecal(const olc::vf2d& pos, const std::string& sText, const float fAngle, const olc::vf2d& center, const olc::vf2d& scale, const Pixel col )
    {
	...
	void Font::DrawStringPropDecal(const olc::vf2d& pos, const std::string& sText, const olc::vf2d& scale, const Pixel col)
	{
		olc::vf2d spos = { 0.0f, 0.0f };
		for (auto c : sText)
		{
	...
	void Font::DrawRotatedStringPropDecal(const olc::vf2d& pos, const std::string& sText, const float fAngle, const olc::vf2d& center, const olc::vf2d& scale, const Pixel col )
    {
		olc::vf2d spos = center;
